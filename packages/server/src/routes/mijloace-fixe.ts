...
mijloaceFixeRoutes.get("/", async (c) => {
  ...
  const items: MijlocFix[] = result.map((row) => ({
    ...
    sursaFinantare: row.sursaFinantare ? {
      ...
      capitol: row.sursaFinantare.capitol ?? false,
      codCapitol1: row.sursaFinantare.codCapitol1 ?? undefined,
      codCapitol2: row.sursaFinantare.codCapitol2 ?? undefined,
...
mijloaceFixeRoutes.get("/:id", async (c) => {
  ...
  const data: MijlocFix = {
    ...
    sursaFinantare: result.sursaFinantare ? {
      ...
      capitol: result.sursaFinantare.capitol ?? false,
      codCapitol1: result.sursaFinantare.codCapitol1 ?? undefined,
      codCapitol2: result.sursaFinantare.codCapitol2 ?? undefined,
  ...
  async (c) => {
    ...
    const responseData: MijlocFix = {
      ...
      sursaFinantare: created.sursaFinantare ? {
        ...
        capitol: created.sursaFinantare.capitol ?? false,
        codCapitol1: created.sursaFinantare.codCapitol1 ?? undefined,
        codCapitol2: created.sursaFinantare.codCapitol2 ?? undefined,
      ...
      cont: created.cont ? {
        ...
        titlu: created.cont.titlu ?? false,
  ...
  async (c) => {
    ...
    const responseData: MijlocFix = {
      ...
      sursaFinantare: updated.sursaFinantare ? {
        ...
        capitol: updated.sursaFinantare.capitol ?? false,
        codCapitol1: updated.sursaFinantare.codCapitol1 ?? undefined,
        codCapitol2: updated.sursaFinantare.codCapitol2 ?? undefined,
      ...
      cont: updated.cont ? {
        ...
        titlu: updated.cont.titlu ?? false,
