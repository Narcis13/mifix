...
- [x] **AMO-01**: Calcul amortizare liniara (valoare inventar / durata normala in luni)
- [x] **AMO-02**: Generare amortizare lunara batch (pentru toate MF active si amortizabile)
- [x] **AMO-03**: Actualizare valoare amortizata si valoare ramasa pe MF
- [x] **AMO-04**: Vizualizare istoric amortizari per MF
- [x] **AMO-05**: Vizualizare amortizari pe luna/an (toate MF-urile)
- [x] **AMO-06**: Nu depaseste valoarea de amortizat (ultima luna = rest)

### Rapoarte

- [x] **RAP-01**: Fisa mijlocului fix (date complete + istoric tranzactii + istoric amortizare)
- [x] **RAP-02**: Balanta de verificare cantitativ-valorica (pe gestiuni, cu totaluri)
- [x] **RAP-03**: Jurnal acte operate (istoric tranzactii pe perioada)
- [x] **RAP-04**: Situatie amortizare lunara (amortizari calculate pe luna)
- [x] **RAP-05**: Filtrare rapoarte pe perioada, gestiune, clasificare

### Autentificare

- [x] **AUTH-01**: Login cu user si parola
- [x] **AUTH-02**: Sesiune persistenta (ramane logat intre refresh-uri)
- [x] **AUTH-03**: Logout
...
| AMO-01 | Phase 5 | Complete |
| AMO-02 | Phase 5 | Complete |
| AMO-03 | Phase 5 | Complete |
| AMO-04 | Phase 5 | Complete |
| AMO-05 | Phase 5 | Complete |
| AMO-06 | Phase 5 | Complete |
| RAP-01 | Phase 6 | Complete |
| RAP-02 | Phase 6 | Complete |
| RAP-03 | Phase 6 | Complete |
| RAP-04 | Phase 6 | Complete |
| RAP-05 | Phase 6 | Complete |
